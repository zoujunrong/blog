  ...
  .header-pic:hover {
    ...
    <div class="jumbotron masthead" style="margin-top: -20px;">
      <div class="container header-pic">
        <a href="/profile"><img style="max-width: 100px;" class="img-circle" title="主页"  src="https://pic2.zhimg.com/ec7c6dcab134dcaaac8eab5367a2f42d_xl.jpg" alt="头像" data-toggle="tooltip" data-placement="top"></a><label style="position: absolute;" class="icon-edit" title="编辑头像">&nbsp;&nbsp;<button type="button" class="btn btn-default btn-xs pull-right">取消订阅</button></label>
        <h3>Bootstrap</h3>
